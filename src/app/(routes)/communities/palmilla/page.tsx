...
export default function PalmillaPage() {
  return (
    <>
      {/* Structured Data */}
      <CommunitySchema 
        communityName="Palmilla"
        description="Resort-style community in The Vistas Summerlin featuring luxury homes with palm landscaping and spa facilities."
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative py-32 bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 text-white overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-20 left-10 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute top-40 right-20 w-80 h-80 bg-green-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-emerald-500/20 to-green-500/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-8 py-4 text-emerald-200 font-medium mb-8 shadow-lg">
                <TreePine className="w-6 h-6" />
                <span>🌴 Resort Living</span>
              </div>

              <h1 className="text-6xl lg:text-7xl font-bold mb-8 bg-gradient-to-r from-white via-emerald-200 to-green-200 bg-clip-text text-transparent leading-tight">
                Palmilla
                <span className="block text-4xl lg:text-5xl mt-4">Resort-Style Luxury</span>
              </h1>
              
              <p className="text-2xl text-emerald-100 max-w-4xl mx-auto leading-relaxed mb-12">
                Discover Palmilla, a resort-style community in The Vistas Summerlin 
                featuring luxury homes with palm landscaping and spa facilities.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-8">
                  Palmilla: Resort-Style Living
                </h2>
                
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  <p className="text-xl mb-6">
                    Palmilla brings resort-style luxury to The Vistas Summerlin, 
                    featuring luxury homes with palm landscaping and access 
                    to world-class spa facilities and amenities.
                  </p>
                  ...
                  <p className="mb-6">
                    Palmilla is designed for those who appreciate resort-style 
                    amenities and tropical landscaping. This luxurious community 
                    features homes with palm landscaping, spa facilities, and 
                    access to tennis courts and community events.
                  </p>
                  ...
                  <p className="mb-6">
                    Homes in Palmilla range from $650,000 to $1.5 million, featuring 
                    resort-style architecture, palm landscaping, and spacious layouts. 
                    Many properties include private patios, outdoor kitchens, and 
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-3xl p-8 shadow-xl">
                  <Image
                    src="/subcommunities/IMG_0737.JPG"
                    alt="Palmilla community in The Vistas Summerlin - resort-style luxury homes with palm landscaping"
                    width={600}
                    height={400}
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-gray-600 italic">
                      "Palmilla offers resort-style living with tropical palm landscaping."
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Amenities Section */}
        <section className="py-24 bg-gradient-to-br from-gray-50 via-emerald-50 to-green-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Palmilla Community Amenities
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Experience resort-style living with palm landscaping and spa facilities.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Luxurious resort-style pool with cabanas, spa features, 
                  and tropical landscaping for year-round enjoyment.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Palm Landscaping</h3>
                <p className="text-gray-600 leading-relaxed">
                  Beautiful palm landscaping throughout the community, 
                  creating a tropical resort atmosphere.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Luxurious spa facilities including saunas, steam rooms, 
                  and relaxation areas for ultimate wellness.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Regular community events including pool parties, 
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Scenic walking paths winding through palm landscaping 
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 via-emerald-50 to-green-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Current Luxury Homes for Sale in Palmilla
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-12">
              Discover our curated selection of luxury homes in Palmilla. Each property offers exceptional value with resort-style amenities and palm landscaping.
            </p>
        ...
        {/* Contact Section */}
        <section className="py-24 bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-8">
              Ready to Experience Resort Living in Palmilla?
            </h2>
            <p className="text-xl text-emerald-100 mb-12 max-w-3xl mx-auto">
              Let Dr. Jan Duffy guide you through Palmilla's luxury real estate market 
